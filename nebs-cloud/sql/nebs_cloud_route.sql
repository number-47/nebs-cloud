/*
 ...
 Source Schema         : nebs_cloud_route
...
db.getCollection("blackList").insert([ {
    ...
    _class: "cc.mrbird.nebs.gateway.entity.BlackList"
} ]);
...
db.getCollection("rateLimitRule").insert([ {
    ...
    _class: "cc.mrbird.nebs.gateway.enhance.entity.RateLimitRule"
} ]);
...
db.getCollection("routeUser").insert([ {
    ...
    _class: "cc.mrbird.nebs.gateway.enhance.entity.RouteUser"
} ]);
db.getCollection("routeUser").insert([ {
