package com.number47.nebs.gateway.filter;

import com.netflix.zuul.ZuulFilter;
import com.netflix.zuul.context.RequestContext;
import com.number47.nebs.gateway.properties.NebsGatewayProperties;
...
public class NebsGatewayRequestFilter extends ZuulFilter {
	...
	public Object run() {
		...
		byte[] token = Base64Utils.encode((NebsConstant.ZUUL_TOKEN_VALUE).getBytes());
		ctx.addZuulRequestHeader(NebsConstant.ZUUL_TOKEN_HEADER, new String(token));
		return null;
	}
}