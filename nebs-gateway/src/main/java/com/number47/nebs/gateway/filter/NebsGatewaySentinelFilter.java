...
import com.number47.nebs.gateway.fallback.NebsGatewayBlockFallbackProvider;
...
@Slf4j
@Configuration
public class NebsGatewaySentinelFilter {
	...
	@PostConstruct
	public void doInit() {
		ZuulBlockFallbackManager.registerProvider(new NebsGatewayBlockFallbackProvider());
		initGatewayRules();
	}
	/**
	 * 定义验证码请求限流，限流规则：
